...
<div id="slider-cycle" class="slider cycle no-responsive slider_cycle group" style="height:485px;">
    <ul class="slider">
        ...
        @foreach($sliders as $k => $item)
                ...
                <li>
                    <div class="slide-holder" style="background:  url({{ asset(config('settings.theme')) }}/images/{{ $item->img }}) no-repeat center center" style="height:483px;">
                        <div class="slide-content-holder inner" style="height:483px;">
                            @if($i%2 != 0 )
                                <div class="slide-content-holder-content" style="position: absolute; top:20px;right:600px;">
                            @else
                            ...
                            @endif
                                ...
                                </div><!-- закриває div або if або else -->
                        </div>
                    </div>
                </li>
            @set($i, $i+1)
...
<div class="mobile-slider">
    <div class="slider fixed-image inner"><img src="{{ asset(config('settings.theme')) }}/images/slider-cycle/laminat-haro-laminate.jpg" alt="" /></div>
</div>
@endif